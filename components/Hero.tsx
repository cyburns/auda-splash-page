...
import DarkModePhones from "@/public/images/auda-black-phones.png";
import DarkBackgroundImage from "@/public/images/auda-bg-2-lg.png";
...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="mx-2 flex flex-row mr-5">
        {mediumScreenSize && (
          <div>
            <Image
              src={DarkModePhones}
        ...
        <div className="flex flex-col max-w-sm xl:mr-20 lg:mt-0 mt-24">
          ...
          <h1 className="text-white text-md font-medium mt-5">
            Join our mailing list to get updates as soon as they come out.
          </h1>
          <div className="mt-5 flex flex-col ">
            <input
              type="text"
              className="bg-[#303030] mt-2 placeholder-white px-3 py-4 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50"
